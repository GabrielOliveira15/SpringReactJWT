...
import { lerIdProfessor, alterarProfessor } from '../../services/ProfessorService';
   ...
   useEffect(()=>{
    ...
    useEffect(() => {
        ...
        const lerProfessor = async () => {
            ...
            setIdCidade(data.object.cidade.idCidade);
        }
    ...
    const onSubmitProfessor = (e) => {
      ...
      salvarAlteracaoProfessor(professor)
   }

   const salvarAlteracaoProfessor = async ( professor ) => {
        const data = await alterarProfessor(idProfessor, professor);
        console.log(data);
        let erro={} 
        if (data.status === 400){
